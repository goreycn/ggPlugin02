package antlr;// Generated from /Users/goreyjp/Desktop/ggPlugin02/src/Swift.g4 by ANTLR 4.5.3
...
public class SwiftParser extends Parser {
	...
	public final Assignment_operatorContext assignment_operator() throws RecognitionException {
		...
		try {
			...
			{
			setState(2332);
			if (!(SwiftSupport.isBinaryOp(_input))) throw new FailedPredicateException(this, "antlr.SwiftSupport.isBinaryOp(_input)");
			setState(2333);
			match(EQUAL);
			}
		}
	...
	public final Negate_prefix_operatorContext negate_prefix_operator() throws RecognitionException {
		...
		try {
			...
			{
			setState(2335);
			if (!(SwiftSupport.isPrefixOp(_input))) throw new FailedPredicateException(this, "antlr.SwiftSupport.isPrefixOp(_input)");
			setState(2336);
			match(SUB);
			}
		}
	...
	public final Build_ANDContext build_AND() throws RecognitionException {
		...
		try {
			...
			{
			setState(2338);
			if (!(SwiftSupport.isOperator(_input,"&&"))) throw new FailedPredicateException(this, "antlr.SwiftSupport.isOperator(_input,\"&&\")");
			setState(2339);
			match(AND);
			setState(2340);
			match(AND);
	...
	public final Postfix_operatorContext postfix_operator() throws RecognitionException {
		...
		try {
			...
			{
			setState(2365);
			if (!(SwiftSupport.isPostfixOp(_input))) throw new FailedPredicateException(this, "antlr.SwiftSupport.isPostfixOp(_input)");
			setState(2366);
			operator();
			}
		}
